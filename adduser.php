            ...
            <div class="card-body">
                <form action="insert.php" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="password" required class="form-control" id="inputEmail3" placeholder="password" name="password" pattern="^[a-zA-Z0-9&@]+$" minlength="8" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-3 col-form-label">Confirm Password</label>
                        <div class="col-sm-9">
                            <input type="password" required class="form-control" id="inputEmail3" placeholder="Confirm password" name="conpassword" pattern="^[a-zA-Z0-9&@]+$" minlength="8" required>
                        </div>
                    </div>
